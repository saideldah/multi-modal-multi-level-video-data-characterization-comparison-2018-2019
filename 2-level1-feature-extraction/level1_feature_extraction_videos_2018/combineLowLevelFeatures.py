...
def generatePercentageDescriptors(inputXMLFile, outputXMLFile, nbSegments=1):
    ...
    listIntensityVariationsInter, listIntensityVariationsIntra, nbTransitions = getKeyframesInterIntraSegmentsIntensityVariation(
        inputXMLFile, nbSegments)
...
if __name__ == '__main__':
    inputXMLPath = "C:/code/features/input/structure_analysis/dev/2/"
    outputXMLPath = "C:/code/features/input/structure_analysis/dev/"
    file_name = "Aabbey1-DavidHartmanChallengesFacingModernJewryInIsraelAndTheD328.xml"
    generatePercentageDescriptors(inputXMLPath + file_name, outputXMLPath + file_name, 1)
